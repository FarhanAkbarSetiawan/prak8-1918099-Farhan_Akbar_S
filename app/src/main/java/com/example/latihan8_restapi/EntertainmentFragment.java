package com.example.latihan8_restapi;
...
public class EntertainmentFragment extends Fragment {
    String api_key = "2a583bd3a593465a94402dba8892f0d3";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
                             ...
                             @Nullable Bundle savedInstanceState) { View v = inflater.inflate(R.layout.entertainmentfragment,null);
